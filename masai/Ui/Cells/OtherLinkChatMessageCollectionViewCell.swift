//
//  OtherLinkChatMessageCollectionViewCell.swift
//  masai
//
...
class OtherLinkChatMessageCollectionViewCell: OtherAvatarBaseCollectionViewCell, ChatCell {
    ...
    static let identifier = "OtherLinkChatMessageCollectionViewCell"
    ...
    static func calculateHeight(for message: ChatMessage) -> CGFloat {
        ...
        if let linkTitle = message.linkTitle {
            titleLabelHeight = UILabel.height(with: linkTitle, numberOfLines: 3, font: UIFont.systemFont(ofSize: 15), width: staticContentWidth - labelMargins)
        }
